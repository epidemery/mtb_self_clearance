...
params_sampled = readRDS(here::here("results",paste0("sampled_parameters_self_cure_", file_suffix, ".Rdata")))

parameters = data.frame(params_sampled, "chi_f"= 0, "a_l" = 0.2, "a_d" = 0.2, "phi_f" = 1, "mu" = 0)
...
saveRDS(trajectories_cohorts, file = here::here("results", paste0("trajectories_cohorts_self_cure_JPN_",file_suffix,".Rdata")))
...
saveRDS(trajectories_cohorts, file = here::here("results", paste0("trajectories_cohorts_self_cure_CHN_",file_suffix,".Rdata")))
...
saveRDS(trajectories_cohorts, file = here::here("results", paste0("trajectories_cohorts_self_cure_IND_",file_suffix,".Rdata")))
